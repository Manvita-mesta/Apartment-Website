    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">View Booked Flat</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h2 style="font-weight: bold;">View Booked Flat</h2>
    ...
    <div class="container">
        <div class="row py-4">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT b.*, u.name AS user_name, bd.name AS building_name, f.id, f.flat_number
                    FROM booking b
                    INNER JOIN user u ON b.user_id = u.id
                    INNER JOIN building bd ON b.building_id = bd.id
                    INNER JOIN flat f ON b.id = f.id
                    WHERE b.booking_type = 'Flat'";
