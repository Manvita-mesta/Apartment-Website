...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $password="MGr".rand(100000, 999999)."$";

        if(mysqli_query($conn,"INSERT INTO `user`(`name`, `email`, `contact`, `password`, `status`, `type`) VALUES ('$name', '$email', '$contact', '$password', true, 'Manager')"))
        {
            echo "<script>alert('Manager added successfully..!')</script>";
        }
        else
        {
            echo "<script>alert('Unable to add manager..!')</script>";
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Add Manager</h4>
                </div>
                <div class="card-body">
                <form action="#" method="post">
                  <div class="form-group row">
                    <div class="col-sm-8">
                        <input type="text" placeholder="Enter Name" class="form-control input-style" name="name" id="validationDefault01"  pattern="^[A-Za-z]+(?: [A-Za-z]+)*$" title="The name should only contain letters and spaces." required>
                    </div>
                </div>
                    <div class="form-group row">
                        <div class="col-sm-8">
