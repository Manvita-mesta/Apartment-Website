...
if (isset($_POST['add'])) {
    ...
    if (mysqli_query($conn, "INSERT INTO user (name, password, email, contact,status, type) VALUES ('$name', '$password', '$email', '$contact', 'Active', 'User')")) {
            echo "<script>alert('Registered successfully .');location.href='index.php';</script>";
        } else {
            echo "<script>alert('Unable to Registered!! .');location.href='index.php';</script>";
        }
    }
?>
<!DOCTYPE html>
